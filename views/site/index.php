...
<div class="site-index">
 ...
 <div class="box box-primary direct-chat direct-chat-primary">
            <div class="box-header with-border">
              <h3 class="box-title">DILG COOPERATIVE - HOME PAGE</h3>
                 ...
                 <div class="col-md-3">
                    <div class="info-box">
                            <span class="info-box-icon bg-green"><i class="fa fa-fw fa-users"></i></span>
                             ...
                             <div class="info-box-content">
                                    <span class="info-box-text">MEMBERSs</span>
...
<div class="col-md-3">
            ...
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" style="width:200px;" src="<?php echo \Yii::$app->request->BaseUrl ?>/images/logo.png" alt="User profile picture">

             <br/>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Founded</b> <a>April 18, 2018</a>
                </li>
                <li class="list-group-item">
                  <b>Location</b> <a >Prk. Dahlia, Visayan Village Tagum City Davao del Norte</a>
                </li>
                <li class="list-group-item">
              ...
              <a href="#" class="btn btn-primary btn-block"><b>JOIN NOW</b></a>
            </div>
            <!-- /.box-body -->
          </div>
                </div>
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  ...
                  <div class="product-info">
                    ...
                    <span class="product-description">
                          Loan Installment now has a uniform or consistent monthly amortization.
                        </span>
                  </div>
                </li>
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title">Member Information Conflict
                      <span class="label label-warning pull-right">Fix</span></a>
                    <span class="product-description">
                          System now detects whether a new encoded member already exists to avoid data redundancy.
                        </span>
                  </div>
                </li>
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title">UI Enhancement
                      <span class="label label-warning pull-right">Fix</span></a>
                    <span class="product-description">
                          Texts were made larger for a better and clearer viewing.
                        </span>
                  </div>
                </li>
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    ...
                    <span class="product-description">
                          New Loan Products requested were now included in the system.
                        </span>
                  </div>
                </li>
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title">Emailing Facility
                      <span class="label label-success pull-right">New!</span></a>
                    <span class="product-description">
                          The System now a facility that enables the user to email the members when their accounts are about to due.
                        </span>
                  </div>
                </li>
                <!-- /.item -->
