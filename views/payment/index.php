...
$paymentRecordList = yii\helpers\Html::encode(json_encode($paymentRecordList, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE));
?>
<payment-record
	:data-model='<?= $model ?>'
	:data-payment-list='<?= $paymentModelList ?>'
	:data-particular-list='<?= $particularList ?>'
	:data-payment-record='<?= $paymentRecordList ?>'
	>
</payment-record>