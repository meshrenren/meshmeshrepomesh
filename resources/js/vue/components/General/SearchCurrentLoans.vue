<template>
    <el-dialog title="Find Loan Account" :visible.sync="dialogVisible"  width="45%" top = "20px" @close="closeModal">      
        ...
        <el-table :data="tableData" style="width: 100%" height="400" stripe border v-loading = "isGettingMember">
            <el-table-column label="Name" >
                <template slot-scope="scope">
                    <p><b>{{ scope.row.member.fullname }}</b></p>
                </template>
            </el-table-column>
            ...
            <el-table-column label="Prin. Balance" >
                <template slot-scope="scope">
        ...
        <span slot="footer" class="dialog-footer">
             <el-button @click="getMember()">Find</el-button>
...
export default {
    ...
    methods: {
        getMember(){
            ...
            axios.post(this.$baseUrl+'/loan/get-current-loans', data).then((result) => {
                let res = result.data
                let type = ""
                let message = ""
                this.tableData = res
                console.log("heyow", res)
