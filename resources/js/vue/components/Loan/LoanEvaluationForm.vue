	        	...
	        	<div class = "col-md-12">
	        		...
	        		<table style="text-align: left;" class = "evaluation-form">
	        			...
	        			<tr>
	        				<th>Share Capital: </th>
	        				<td>
	        					<span v-if = "shareAccount">{{ $nf.formatNumber(shareAccount.balance, 2) }}</span>
	        				</td>
	        			</tr>
	        			<tr>
	        				<th>Maximum Loan Amount: </th>
	        				<td>
	        					<span v-if = "shareAccount">{{ $nf.formatNumber(shareAccount.max_amount, 2) }}</span>
	        				</td>
	        			</tr>
	        		</table>
	        	</div>
	        ...
	        <div class = "row">
	        	<div class = "col-md-12" style = "margin-top: 20px;">
	        		<table class="centertable evaluation-form" style="min-width: 400px;">
		        		...
		        		<tr>
		        			<td>
		        				<span>{{ $nf.formatNumber(evaluationForm.debit_loan, 2) }}</span>
						  	</td>
						  	<th>
		        				<span class = "label-title">LOAN</span>
						  	</th>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.credit_loan, 2) }}</span>
						  	</td>
						</tr>

						<tr>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.debit_interest, 2) }}</span>
						  	</td>
						  	<th>
		        				<span class = "label-title">Interest</span>
						  	</th>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.credit_interest, 2) }}</span>
						  	</td>
						</tr>

						<tr>
							<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.debit_preinterest, 2) }}</span>
						  	</td>
						  	<th>
		        				<span class = "label-title">Prepaid Int</span>
						  	</th>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.credit_preinterest, 2) }}</span>
						  	</td>
						</tr>

						<tr>
							<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.debit_redemption_ins, 2) }}</span>
						  	</td>
						  	<th>
		        				<span class = "label-title">Redemp. Ins.</span>
						  	</th>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.credit_redemption_ins, 2) }}</span>
						  	</td>
						</tr>
						...
						<tr>
						  	...
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.service_charge_amount, 2) }}</span>
						  	</td>
						</tr>
						...
						<tr>
						  	...
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.savings_retention, 2) }}</span>
						  	</td>
						</tr>
						...
						<tr>
						  	...
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.notary_amount, 2) }}</span>
						  	</td>
						</tr>
						...
						<tr>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.debit_total, 2) }}</span>
						  	</td>
						  	<th>
		        				<span class = "label-title">TOTAL</span>
						  	</th>
						  	<td>
						  		<span>{{ $nf.formatNumber(evaluationForm.credit_total, 2) }}</span>
						  	</td>
						</tr>
					</table>
	        	</div>
	        	...
	        	<div class = "col-md-12" style = "margin-top: 20px;">
	        		<table  style="text-align: left;" class = "evaluation-form">
	        			<tr>
	        				<th>Loan Amount: </th>
	        				<td>
	        					<span>{{ $nf.formatNumber(evaluationForm.amount, 2) }}</span>
	        				</td>
	        				<td>
	        					&nbsp;&nbsp;&nbsp;&nbsp;
	        				</td>
	        				...
	        				<td>
	        					<span v-if = "latestLoan">{{ $nf.formatNumber(latestLoan.principal, 2) }}</span>
	        				</td>
	        			</tr>
	        			<tr>
	        				<th>Payment/Quincena: </th>
	        				<td>
	        					<span>{{ $nf.formatNumber(evaluationForm.principal_amortization_quincena, 2) }}</span>
	        				</td>
	        				<td>
	        					&nbsp;&nbsp;&nbsp;&nbsp;
	        				</td>
	        				...
	        				<td>
	        					<span v-if = "latestLoan">{{ $nf.formatNumber(latestLoan.principal_balance, 2) }}</span>
	        				</td>
	        			</tr>
	        			<tr>
	        				...
	        				<td>
	        					<span>{{ $nf.formatNumber(evaluationForm.prepaid_amortization_quincena, 2) }}</span>
	        				</td>
	        				<td>
	        					&nbsp;&nbsp;&nbsp;&nbsp;
	        				</td>
	        			...
	        			<tr>
	        				<th>Term: </th>
	        				<td>
	        					<span>{{ $nf.formatNumber(evaluationForm.duration, 2) }}</span>
	        				</td>
	        			</tr>
	        		</table>
	        	</div>
	        		...
	        		<table class = "table table-borderedx" style="text-align: left;">
	        			...
	        			<tbody>
	        				<tr v-for = "trans in loanTransaction">
	        					...
	        					<td>{{ trans.OR_no }}</td>
	        					<td class="centerno">{{ $nf.formatNumber(trans.principal_paid, 2) }}</td>
...
var printOptions =  {
 	name: '_blank',
  	...
  	styles: [
		...
		window.Yii.baseUrl + "/css/assets/site.scss",
