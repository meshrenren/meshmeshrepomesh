                    ...
                    <el-col :span="8">
                        <div class="box box-default">
                            ...
                            <div class="box-footer clearfix">
                                <el-button class = "auto-width pull-right" type = "primary" @click = "addOtherAccounts">ADD</el-button>
                            </div>
                        </div>
                    </el-col>
                    <el-col :span="16">
                        <div class="box box-info">
                            ...
                            <div class="box-footer clearfix">
                                <el-button class = "auto-width pull-right" type = "primary" @click = "addAccounts">ADD</el-button>
                            </div>
                        </div>
                    </el-col>
                </el-row> 
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <el-button class = "auto-width pull-right" size = "medium" type = "primary" @click = "finishPayment()">SAVE</el-button>
                            <el-button class = "auto-width pull-right" size = "medium" type = "danger" @click = "finishPayment()">CANCEL</el-button>
                        </div>
                    </div>
                    <div class="box-body psyment-entry-list">
                        <el-table
                            :data="allTotalAccount"
                            border striped
                            style="width: 100%"
                            max-height = "480px">
                            <el-table-column
...
export default {
    ...
    data: function () {  
        ...
        let accountModel = {key : null, member_id : null, account_no : null, product_id : null, product_name : "", type : null, balance : 0, amount: 0, entry_type : null}
    	return {
